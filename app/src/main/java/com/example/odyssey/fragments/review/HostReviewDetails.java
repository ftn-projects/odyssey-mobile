...
public class HostReviewDetails extends Fragment {


    private HostReview review;
    public final String ARG_NOTIFICATION = "review";

    public HostReviewDetails() {
        // Required empty public constructor
    }

    public static HostReviewDetails newInstance(String param1, String param2) {
        return new HostReviewDetails();
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(getArguments()!=null && getArguments().containsKey(ARG_NOTIFICATION))
            review = (HostReview) getArguments().getSerializable(ARG_NOTIFICATION);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_host_review_details, container, false);
    }
