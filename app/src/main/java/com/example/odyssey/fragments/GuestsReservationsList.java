...
public class GuestsReservationsList extends Fragment implements ReservationsListener {

    View v;
    TextView status;
    boolean[] selectedLanguage;
    ArrayList<Integer> statusList = new ArrayList<>();
    String[] statusArray = {"Accepted","Requested", "Declined", "Cancelled request", "Cancelled reservation"};
    String date1 = "", date2 = "";
    List<AccreditReservation> requests = new ArrayList<>();
    Button search;
    MaterialButton dateSelect;
    TextInputEditText title;
    public GuestsReservationsList() {
    }
    public static GuestsReservationsList newInstance() {return new GuestsReservationsList();}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_guests_reservations_list, container, false);
        ...
        call.enqueue(new Callback<List<AccreditReservation>>() {
            ...
            public void onResponse(Call<List<AccreditReservation>> call, Response<List<AccreditReservation>> response) {
                if(response.code() == 200){
                    ...
                    for(AccreditReservation reservation: requests){
                        GuestsReservationsCard card = new GuestsReservationsCard(requireContext(), GuestsReservationsList.this);
